...
-define(storage_name, client_server_fix_storage_dets).
...
init_per_testcase(_TestCase, Config) ->
   fix_storage_dets:start_link(#fix_session_config{
         storage = ?storage_name,
         storage_dir=".",
         session_id = client_server,
         storage_flags = []}),
   Config.

end_per_testcase(_TestCase, Config) ->
   ok = file:delete("./client_server.metadata"),
   ok = file:delete("./client_server.storage"),
   Config.
