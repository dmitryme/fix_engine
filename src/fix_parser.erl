...
-spec set_int32_field(msgRef(), tagNum(), integer()) -> ok | {error, reason()}.
set_int32_field(_MsgRef, _FieldNum, _Value) ->
   {error, library_not_loaded}.

-spec set_int64_field(msgRef(), tagNum(), integer()) -> ok | {error, reason()}.
set_int64_field(_MsgRef, _FieldNum, _Value) ->
   {error, library_not_loaded}.

-spec set_double_field(msgRef(), tagNum(), float()) -> ok | {error, reason()}.
set_double_field(_MsgRef, _TagNum, _Value) ->
   {error, library_not_loaded}.

-spec set_string_field(msgRef(), tagNum(), string()) -> ok | {error, reason()}.
set_string_field(_MsgRef, _TagNum, _Value) ->
   {error, library_not_loaded}.

-spec set_char_field(msgRef(), tagNum(), char()) -> ok | {error, reason()}.
set_char_field(_MsgRef, _TagNum, _Value) ->
   {error, library_not_loaded}.

-spec get_int32_field(msgRef(), tagNum()) -> {ok, integer()} | {error, reason()}.
get_int32_field(_MsgRef, _TagNum) ->
   {error, library_not_loaded}.

-spec get_int64_field(msgRef(), tagNum()) -> {ok, integer()} | {error, reason()}.
get_int64_field(_MsgRef, _TagNum) ->
   {error, library_not_loaded}.

-spec get_double_field(msgRef(), tagNum()) -> {ok, float()} | {error, reason()}.
get_double_field(_MsgRef, _TagNum) ->
   {error, library_not_loaded}.

-spec get_string_field(msgRef(), tagNum()) -> {ok, string()} | {error, reason()}.
get_string_field(_MsgRef, _TagNum) ->
   {error, library_not_loaded}.

-spec get_char_field(msgRef(), tagNum()) -> {ok, char()} | {error, reason()}.
